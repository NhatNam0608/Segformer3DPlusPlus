...
from attentions.esa import ESA
...
#     input = torch.rand((1, 3, 128, 128, 128)).to(device)
#     model = build_segformer3d_model(config).to(device)
#     checkpoint_path = "/kaggle/input/best_dice_checkpoint/pytorch/default/1/best_dice_checkpoint/pytorch_model.bin"
...
#     sns.histplot(sample_means, kde=True, bins=50, color='seagreen')
#     plt.title("Distribution of Sample Means (30 samples each)")
#     plt.xlabel("Sample Mean Inference Time (seconds)")
#     plt.ylabel("Frequency")
#     plt.savefig("sample_mean_distribution(segformer3d).png")
# ##################################################################################